...
#########################################################
#genre count
#train['genre_ids'] = train['genre_ids'].cat.add_categories(['no_genre'])
#train['genre_ids'].fillna('no_genre', inplace=True)
#train['genre_count'] = train['genre_ids'].apply(genre_count).astype(np.int8)
#test['genre_ids'] = test['genre_ids'].cat.add_categories(['no_genre'])
#test['genre_ids'].fillna('no_genre', inplace=True)
#test['genre_count'] = test['genre_ids'].apply(genre_count).astype(np.int8)
...
train['bd']=train['bd'].apply(is_zero).astype(np.int8)
test['bd']=test['bd'].apply(is_zero).astype(np.int8)

#########################################################

train['bd']

#del songs,songs_extra
#gc.collect()
