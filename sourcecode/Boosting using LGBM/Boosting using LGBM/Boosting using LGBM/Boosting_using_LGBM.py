...
print('Loading data...')
data_path = '//myhome.itap.purdue.edu/puhome/pu.data/Desktop/Thanks Emily!/'


train = pd.read_csv(data_path + 'train.csv')
                   # ,dtype={'msno' : 'category','source_system_tab' : 'category','source_screen_name' : 'category','source_type' : 'category','target' : np.uint8,'song_id' : 'category'})

test = pd.read_csv(data_path + 'test.csv')#, dtype={'msno' : 'category','source_system_tab' : 'category','source_screen_name' : 'category','source_type' : 'category','song_id' : 'category'})

songs = pd.read_csv(data_path + 'songs.csv')#,dtype={'genre_ids': 'category','language' : 'category','artist_name' : 'category','composer' : 'category','lyricist' : 'category','song_id' : 'category'})
members = pd.read_csv(data_path + 'members.csv')#,dtype={'city' : 'category','bd' : np.uint8,'gender' : 'category', 'registered_via' : 'category'},parse_dates=['registration_init_time','expiration_date'])
...
_small_mean = _mean_song_length/2
_big_mean =  _mean_song_length*3/2
...
A = train.drop(train.index[:4877417])
b = A['target'].values
